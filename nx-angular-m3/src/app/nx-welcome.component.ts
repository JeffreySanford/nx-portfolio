      ...
      <div class="container">
        ...
        <div id="commands" class="rounded shadow">
          ...
          <details>
            ...
            <pre><span># Build</span>
nx build nx-angular-m3
<span># Test</span>
nx test nx-angular-m3
<span># Lint</span>
nx lint nx-angular-m3
<span># Run them together!</span>
nx run-many -p nx-angular-m3 -t build test lint</pre>
          </details>
          <details>
            <summary>
              <svg
            ...
            <pre>nx show project nx-angular-m3</pre>
          </details>
