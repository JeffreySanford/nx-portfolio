      ...
      <div class="container">
        ...
        <div id="middle-content">
          ...
          <div id="other-links">
            ...
            <div id="nx-cloud" class="rounded shadow">
              ...
              <a
                href="https://cloud.nx.app/connect/cjCAuC3BCr"
                target="_blank"
                rel="noreferrer"
              >
        ...
        <div id="commands" class="rounded shadow">
          ...
          <details>
            ...
            <pre><span># Build</span>
nx build nx-portfolio
<span># Test</span>
nx test nx-portfolio
<span># Lint</span>
nx lint nx-portfolio
<span># Run them together!</span>
nx run-many -p nx-portfolio -t build test lint</pre>
          </details>
          <details>
            <summary>
              <svg
            ...
            <pre>nx show project nx-portfolio</pre>
          </details>
